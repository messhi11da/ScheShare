...
if (isset($_POST['schedule_id'])) {
    ...
    if (!empty($scheduleId)) {
        ...
        if ($formFlag === "0") {
            ...
            echo "</tr>";
            echo "<td>時刻：</td>";
            echo "<td><input type='time' name='start' step='300' value='" . escape($schedule['start_time']) . "'>";
            echo "~";
            echo "<input type='time' name='end' step='300' value='" . escape($schedule['end_time']) . "'></td>";
            echo "<tr>";
            echo "<td>メモ：</td>";
            ...
            echo "</tr>";
            echo "<td>時刻：</td>";
            echo "<td><input type='time' name='start' step='300'>";
            echo "~";
            echo "<input type='time' name='end' step='300'></td>";
            echo "<tr>";
            echo "<td>メモ：</td>";
